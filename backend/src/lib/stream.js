...
export const chatClient = StreamChat.getInstance(apiKey, apiSecret); // this well be use for chat feratures
export const streamClient = new StreamClient(apiKey, apiSecret); // this will use for video calls
